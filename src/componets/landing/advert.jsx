    ...
    <div className='bg-[#171719] py-20 md:px-[84px] px-[20px] overflow-hidden'>
      ...
      >
        <SwiperSlide className='bg-[#2C3436] rounded-[25px] overflow-hidden'>
            <div className='flex flex-col gap-5 md:gap-0 px-[10px] md:flex-row items-center'>
                <img src={girl} alt=""  className='md:w-[459px] w-[100%] h-[300px] md:h-[522px] md:relative top-10'/>
                <div className='flex flex-col gap-3 items-center  md:start '>
                    <img src={game} alt="" className='md:w-[60px] w-[45px] h-[20px] md:h-[45px]'/>
                    <h2 className='font-sans font-bold md:text-[54px] md:text-start  text-center  text-[49px] text-white md:w-[476px]'>Experience the Vast Metaverse</h2>
                    <p className='font-sans text-[#9B9B9B] text-center md:text-start text-[20px] md:text-[26px] md:w-[476px] font-medium'>Explore the vast metaverse, unravel the marvelous details of the verse through our blaq VR-headset.</p>
