...
export default function sadvert() {
  return (
    <div className=' flex flex-col justify-center items-center h-[300px] px-[20px] md:px-0 :w-[100%] bg-[#171719] '>
        <img src={bdg} alt="" className='md:h-[800px] h-[300px] w-[100%] md:w-[100%]'/>
        <div className='relative md:bottom-[650px] flex flex-col gap-3 justify-center items-center bg-[#2C3436] rounded-[25px] px-[10px] md:px-0 py-14  w-[100%] md:w-[843px] h-[600px]'>
